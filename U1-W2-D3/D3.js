...
console.log("Characters names:", charactersNames)
/* ESERCIZIO 3
  Seguendo i passaggi precedenti crea un nuovo array chiamato "femaleCharacters" e inserisci al suo interno tutti gli oggetti femminili.
*/
let femaleCharacters = []

for (let i=0;i<starWarsCharacters.length;i++)  {if
 (starWarsCharacters[i].gender === "female") {femaleCharacters.push(starWarsCharacters[i])}
}
console.log("Woman Objects:", femaleCharacters)
...
console.log("Personaggi divisi per colore degli occhi:", eyeColor);
...
let crewMass = 0
let i = 0
while (i<starWarsCharacters.length) {crewMass += starWarsCharacters[i].mass; i++;
console.log ("Risultato parziale", crewMass)}
...
if (crewMass<500) {console.log("Ship underloaded")}
else if (crewMass<700) {console.log("Ship is half loaded")}
else if (crewMass<900) {console.log("Warning:Load is over700")}
else if (crewMass<1000) {console.log("Warning:Load is over900")}
...
for (let i =0; i<starWarsCharacters.length; i++) {if (starWarsCharacters[i].gender==="n/a"){
